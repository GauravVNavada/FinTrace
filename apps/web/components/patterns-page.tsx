...
export function PatternsPage() {
  ...
  return <>
    <PageHeading eyebrow="Patterns" title="Recurring operational signals" description={investigationName ? `Investigation-scoped signals derived from ${investigationName}.` : "Patterns are derived from persisted investigation outcomes."}>
    ...
    {!loading && !apiUnavailable && !investigationName && <Card><CardContent className="py-16 text-center text-sm text-muted-foreground">Create an investigation and complete a reconciliation run before patterns can be derived.</CardContent></Card>}
