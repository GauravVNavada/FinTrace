...
**Hardening update (2026-09-03):** The active browser workflow now exposes reconciliation and investigation actions end to end; approval, tenant scope, provider-health access, durable writes, evidence truthfulness, identifier handling, and evaluation reporting have been hardened. The product remains demo-oriented and requires the documented PostgreSQL and browser smoke checks before a production deployment claim.
